function [V_PS, H_PS, XY, TRI, Arcs, dv_ddh]=SolutionTest(V, H, DifInt, dT, B, M, N, num_PS, XY)
% 解决形变速率和高程误差
...
dv_up=0.2;
ddh_low=-30;        % in meters, for height-error increment
ddh_up=30;
dv_size=20;        % grid size for searching solution
ddh_size=20;
