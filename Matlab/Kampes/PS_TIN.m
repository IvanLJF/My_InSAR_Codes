function PS_TIN(infile, numlines, r0, rN, c0, cN)
% 这个函数利用振幅离差指数来获取PS点，并用所有探测到的PS点构建一个自由网。弧段编码矩阵也随此产生。
%%function PS_TIN(infile, numlines);
%
...
%                                 matrix size == k by 3 (K is the total
%                                 number of all arcs in TIN)
%
%  e.g.,   PS_TIN('F:\Phoniex\PS_Points\test\Mat_ADIs.dat', 3200, 1, 3200, 1, 3500);
%            PS_TIN('F:\Phoniex\PS_Points\test\Mat_ADIs.dat', 3200, 901, 1000, 2701, 2800); (a pacth around that subsiding bowl)
%            PS_TIN('F:\Phoniex\PS_Points\test\Mat_ADIs.dat', 3200, 901, 950, 2701, 2750);
%            PS_TIN('F:\Phoniex\PS_Points\test\Mat_ADIs.dat', 3200, 1001, 1100, 2701, 2800);   
%            PS_TIN('F:\Phoniex\PS_Points\test\Mat_ADIs.dat', 3200, 601, 1600, 1451, 3450);
%            PS_TIN('F:\Phoniex\PS_Points\test\Mat_ADIs.dat', 3200, 751, 1500, 2051, 3400);
%
...
% final processing: combination and sorting of three groups of arcs with
