...
;	otSaveNames = strarr(iFileCount)
 ...
 inputdir='D:\myfiles\Software\FM_Data\'
 inputstr = inputdir + '*.hdf'
 numFilesa = FILE_SEARCH(inputstr,count = iFileCount)
 otSaveNames = strarr(iFileCount)
	for ii = 0, iFileCount - 1 do begin
Print, ii, '/', (iFileCount-1)
...
;      if (valrange_ind ne -1) then begin
;       rangex[where(rangex eq 0)] = 1
;      endif
...
;
;     otSaveNames[ii] = tiff_co2out_name
ENVI_BATCH_EXIT
	endfor
