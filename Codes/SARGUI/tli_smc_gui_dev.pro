...
;
@tli/compile
PRO TLI_SMC_GUI_DEV_EVENT, event
    ...
    case uval of
      ...
      'io': BEGIN
        Case STRLOWCASE(event.value) OF
          'open slc file'                      : TLI_SMC_OPEN_SLC
          'read gamma files'                   : TLI_FINDPRO, 'tli_readdata'
          'common files.slc.read whole slc'                     : TLI_FINDPRO, 'tli_readslc'
          'common files.slc.read slc block'                     : TLI_FINDPRO, 'subsetslc'
          'common files.slc.read slc using a structure'         : TLI_FINDPRO, 'slc__define'
          'terrasar-x(.cos)'                   : TLI_SMC_IMPORT_TSX
          'ers(dat_01.001)'                    : TLI_SMC_IMPORT_ERS
          'palsar(.raw)'                       : TLI_SMC_IMPORT_PLS
          'sarlist'                            : TLI_FINDPRO, 'tli_readdata'
          'itab'                               : TLI_FINDPRO, 'tli_readdata'
      ...
      'general': BEGIN
        Case STRLOWCASE(event.value) OF
          'undo'                              : TLI_SMC_DUMMY, inputstr='Functions are not found!'
          'redo'                              : TLI_SMC_DUMMY, inputstr='Functions are not found!'
          'measure value/location'            : TLI_SMC_DUMMY, inputstr='Functions are not found!'
          'zoom'                              : TLI_SMC_DUMMY, inputstr='Functions are not found!'
          'resize image'                      : TLI_SMC_DUMMY, inputstr='Functions are not found!'
          'multi look'                        : TLI_SMC_ML
          'cut out region'                    : TLI_SMC_DUMMY, inputstr='Functions are not found!'
          'mirror vertical'                   : TLI_SMC_DUMMY, inputstr='Functions are not found!'
          'mirror horizontal'                 : TLI_SMC_DUMMY, inputstr='Functions are not found!'
          'transpose'                         : TLI_SMC_DUMMY, inputstr='Functions are not found!'
          'colour palettes'                   : TLI_SMC_DUMMY, inputstr='Functions are not found!'
          'statistics'                        : TLI_SMC_DUMMY, inputstr='Functions are not found!'
          'scatter plot'                      : TLI_SMC_DUMMY, inputstr='Functions are not found!'
          'parameter information'             : TLI_SMC_DUMMY, inputstr='Functions are not found!'
          'binary transform'                  : TLI_SMC_DUMMY, inputstr='Functions are not found!'
          ...
          ELSE: TLI_SMC_DUMMY, inputstr='Functions are not designed!'
        ENDCASE
      END
      ...
      'flat': BEGIN
        Case STRLOWCASE(event.value) OF
          'base_init'                          :  cw_smc_base_init
          'base_perp'                          :
          'phase_slope_base'                   :cw_smc_ph_slope_base
        ENDCASE
      END
      ...
      'unw': BEGIN
        ...
        Case STRLOWCASE(event.value) OF
          ...
          'adf'                                          :  cw_smc_adf
          'corr_flag'                                :    cw_smc_corr_flag
          'neutron'                               :   sargui_neutron
          'residue'                                 :  sargui_residue
          'tree_cc'                                  : sargui_tree_cc
          'grasses'                                  : sargui_grasses
          'ras_mask'                             : sargui_rascc_mask
          'ras_mask_thinning'            : sargui_rascc_mask_thinning
          'mcf'                                          : sargui_mcf
          'interp_ad'                               : sargui_interp_ad
          'unw_model'                           : sargui_unw_model
          'gamma2snaphu_int'            : sargui_gamma2snaphu_int
          'gamma2snaphu_cc'              : sargui_gamma2snaphu_cc
          'snaphu'                                    : sargui_snaphu
          'snaphu2gamma'                    : sargui_snaphu2gamma
      ...
      'qa': BEGIN
        Case STRLOWCASE(event.value) OF
          'dem error.error analysis.error hist'               : TLI_SMC_REPORT_INT_DEM_ERROR
          
          'plot geocoded.int dem'                             : TLI_SMC_PLOT_INT_DEM
          'plot geocoded.ref dem'                             : TLI_SMC_PLOT_REF_DEM
          'plot geocoded.dem error'                           :
...
PRO TLI_SMC_GUI_DEV,STARTFILE=startfile, FILE=startfile_tmp, $
    BLOCK=block, $
  ...
  temp=DIALOG_MESSAGE(info,/center,/information, Title='Sasmac-InSAR Tools')
