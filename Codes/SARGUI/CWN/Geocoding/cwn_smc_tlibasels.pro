PRO CWN_SMC_TLIBASELS_EVENT,EVENT
  ...
  case uname of
    ...
    baselsfile=workpath+PATH_SEP()+TLI_FNAME(infile, /REMOVE_ALL_SUFFIX)+'.base'
...
PRO CWN_SMC_TLIBASELS
  ...
  ;-------------------------------------------------------------------------
  ; Create widgets
  tlb=widget_base(title='tli_gcp_dem',tlb_frame_attr=0,/column,xsize=xsize,ysize=ysize,xoffset=xoffset,yoffset=yoffset)
  ...
  xmanager,'CWN_SMC_TLIBASELS',tlb,/no_block
END