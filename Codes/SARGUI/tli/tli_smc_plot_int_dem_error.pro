...
; History
;
PRO TLI_SMC_PLOT_INT_DEM_ERROR_EVENT, EVENT
  ...
  Case uname OF
    'openinput':BEGIN
    inputfile=dialog_pickfile(title='Sasmac InSAR',/read,filter='*.err', path=workpath,/must_exist)
...
PRO TLI_SMC_PLOT_INT_DEM_ERROR
  ...
  xmanager,'TLI_SMC_PLOT_INT_DEM_ERROR',tlb,/no_block
