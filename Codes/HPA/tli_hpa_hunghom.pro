;
; Experiments for HungHom.
;
PRO TLI_HPA_HUNGHOM

  workpath_orig='/mnt/backup/ExpGroup/HungHom_test'
...
;    TLI_HPA_1LEVEL,workpath_orig, mask_arc=mask_arc, mask_pt_coh=mask_pt_coh, v_acc=v_acc, dh_acc=dh_acc,/ls
    outputfile=hpapath+'vdh_v'+(TLI_TIME(/STR))+'.jpg'
        tli_plot_linear_def,hpapath+'vdh', hpapath+'ave.ras',hpapath+'sarlist_Linux',/show,ptsize=0.001,/refine,delta=3
    STOP
    coef=0.5
