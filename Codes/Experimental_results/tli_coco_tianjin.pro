...
@tli_defingoogle
@kml
PRO TLI_COCO_Tianjin

  ; workpath='/mnt/data_tli/ForExperiment/Lemon_gg/TSX_PS_Tianjin/'
  ; workpath='/mnt/data_tli/ForExperiment/Lemon_gg/TSX_PS_Tianjin_Small/'
  workpath='/mnt/data_tli/ForExperiment/Lemon_gg/TSX_PS_Tianjin_Large/'
  ...
  IF 1 THEN BEGIN
    ...
    ;    TLI_HPA_1level,workpath, mask_arc=mask_arc, mask_pt_coh=mask_pt_coh, v_acc=v_acc, dh_acc=dh_acc,/rg,$
    ;      method=method, coh=coh, pbase_thresh=pbase_thresh,ignore_def=ignore_def
