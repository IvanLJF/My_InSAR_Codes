PRO TLI_ALL_MY_KML
   ...
   tibet_envisat_par='/mnt/data_tli/Data/SLCs/ENVISAT_Tibet/20041014.slc.par'
   hk_tsx_par='/mnt/data_tli/Data/SLCs/TSX_HK_SLC/slc_GAMMA/20101226.slc.par'
   angkor_tsx_par='/mnt/data_tli/Data/SLCs/TSX_Angkor/20130510.slc.par'

   tianjin_palsar_par1='/mnt/data_tli/Data/SLCs/Palsar_Tianjin_447_74/20091025.slc.par'
   ...
   TLI_SLC_Range, tibet_envisat_par, outputfile=resultpath+'Tibet_envisat.kml', annotation='No. of images: 44.'
   TLI_SLC_RANGE, hk_tsx_par, outputfile=resultpath+'HK_tsx.kml', annotation='No. of images: 10.'
   ...
   Print, "Task finished successfully. Time:"+TLI_TIME(/str)
END