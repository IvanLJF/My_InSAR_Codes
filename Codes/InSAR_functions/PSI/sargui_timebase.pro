...
PRO SARGUI_TIMEBASE_EVENT,EVENT
...
PRO SARGUI_TIMEBASE,EVENT
;-创建组件
device,get_screen_size=screen_size
tlb=widget_base(row=1,title='计算时间基线',tlb_frame_attr=1,xsize=330,xoffset=screen_size(0)/3,yoffset=screen_size(1)/3)
;-列表组件
...
xmanager,'SARGUI_TIMEBASE',tlb,/no_block
END