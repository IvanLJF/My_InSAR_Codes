;- 
;- Purpose:
;-    Read params according to the given keyword.
;- Calling Sequence:
;-    result= READ_PARAMS(infile_par, read_kw)
;- Inputs:
;-    infile_par, read_kw
...
;-    None
;- Outputs:
;-    Direct data or lines containing the keyword
;- Commendations:
;-    None
;- Example:
;-    infile= 'D:\ForExperiment\TSX_TJ_1500\20090327.rslc.par'
;-    svp=read_slcpar(infile,'state_vector_position')
;- Modification History:
;-    Long time before: Done writting by T. Li @ InSAR Team in SWJTU
;-    08/02/2012: Add ON_ERROR,2. By T. Li @ InSAR Team in CUHK
;-    09/02/2012: Add judgement for image_format. By T. Li @ InSAR Team in CUHK
FUNCTION READ_PARAMS,INFILE_PAR,READ_KW
