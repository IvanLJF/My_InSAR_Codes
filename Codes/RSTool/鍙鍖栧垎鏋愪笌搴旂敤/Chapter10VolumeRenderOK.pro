...
END
;----------------------------------------------------------------------------
pro Chapter10VolumeRenderOK_Event, event
...
;----------------------------------------------------------------------------
pro Chapter10VolumeRenderOKCleanup,wTopBase
...
rWindow->Draw, rView
XMANAGER, 'Chapter10VolumeRenderOK', wBase, $
       CLEANUP='Chapter10VolumeRenderOKCleanup', /NO_BLOCK
end
