...
END
PRO Chapter07ToolBarSystem
    MyBase =WIDGET_BASE(XSIZE=500,YSIZE=400, TITLE='MyBase', /TOOLBAR, /ROW)
    ...
    XMANAGER, 'Chapter07ToolBarSystem', MyBase
END
